...
namespace GamepadExtension
{
    ...
    public delegate void GamepadButtonHandler(object sender, GamepadButtons e);
    public delegate void GamepadStickHandler(object sender, GamepadState.ThumbstickState e, Vector2 delta);
    public delegate void GamepadTriggerHandler(object sender, GamepadState.TriggerState e);
    ...
    public class GamepadState
    {
        ...
        public readonly GamepadIndex UserIndex;
